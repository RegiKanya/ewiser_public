...
# Create the Client 
client = pygsheets.authorize(service_account_file="xxxxxx") 
#print(client.spreadsheet_titles()) 

def main():
    sheet = client.open_by_key('xxxxxx')
    ...
    worksheet = sheet.worksheet_by_title('xxxx')  # or worksheet = sheet.worksheet_by_title('Munkalap neve')
    worksheet.clear()
